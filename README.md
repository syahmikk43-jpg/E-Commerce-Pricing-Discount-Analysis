...
## Project Background
This project focuses on analysing pricing structures and discount behaviour in an e-commerce retail environment. The dataset contains product-level details such as brand, category, gender, color, current price, previous price, and recommended retail price (RRP).
